...
Feature: Creation, editation and deletion of content
    ...
    # For other types tests would be fairly similar. So to keep
    ...
    Scenario: Access deletion dialog
        Given Edited Use Case page is displayed
