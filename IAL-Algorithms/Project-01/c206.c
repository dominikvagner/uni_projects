...
/**
 * Vloží nový prvek na konec seznamu list (symetrická operace k DLL
 * InsertFirst). V případě, že není dostatek paměti pro nový prvek při operaci
 * malloc, volá funkci DLL_Error().
 *
 * @param list Ukazatel na inicializovanou strukturu dvousměrně vázaného seznamu
